...
Le SFINAE associé à {\tt enable\_if} est un mécanisme permettant de générer  ou pas certains types et certaines fonctions en fonction d'un type donné en argument.
